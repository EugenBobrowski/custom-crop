...
define('CUSTOM_CROP_VERSION', (WP_DEBUG) ? time() : '1.6.2');
...
//        add_action('admin_footer', array($this, 'inline_views'));
    ...
    public function add_featured_image_display_settings($content, $post_id, $attachment_id = false)
    {
        ...
        <a href="#"
           ...
           data-available="<?php echo esc_attr(json_encode(apply_filters('available_thumbnail_ccrop_sizes', array_keys($this->sizes), $post_id))); ?>"
